...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb breadDesign">
    ...
    <li class="breadcrumb-item active">The Simpsons: Hit and Run</li>
  </ol>
</nav>
...
<div class="container-fluid" >
  <div class="row" style="margin-left: 1%;">
    <div class="col">
      <h4>The Simpsons: Hit and Run</h4>
    </div>
  </div>
  <br/>
  <div class="row" style="margin-left: 1%;">
  ...
  <div class="row" style="margin-left: 1%;">
    <div class="col">
      <p>The Simpsons: Hit and Run released on September 16th, 2003 (North America release) for GameCube,
        PlayStation 2, and Xbox. It later released on PC (Microsoft Windows) on November 11th, 2003 (NA release).
        <br/>The game is an Action-adventure, racing game.
        <br/>
        <br/>For Speedrunning, the fastest version is PC (Microsoft Windows) however, I have played it
        on Xbox as well.
        <br/>
        ...
        <a href="https://speedrun.com/shar" target="_blank"> speedrun.com<a></p>
    </div>
  </div>
</div>
  ...
  <table class="table table-hover table-bordered" align="center" style="width: 75%;">
    ...
    <tbody>
      ...
      <?php
        ...
        $achievements = $conn -> prepare("select * from achievements where game_name = 'The Simpsons: Hit and Run' order by date_achieved DESC");
  ...
  <div class="row" style="text-align: center;">
    <div class="col">
      <p>If you want to check out every verified Speedrun of the game check out
        <a href="https://speedrun.com/shar" target="_blank">The Simpsons: Hit and Run
          speedrun.com</a> page. <br/>There are over <strong>250</strong> unique Speedruns of this
