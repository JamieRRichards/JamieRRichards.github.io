...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb breadDesign">
    ...
    <li class="breadcrumb-item active">The SpongeBob SquarePants Movie</li>
  </ol>
</nav>
...
<div class="container-fluid" >
  <div class="row" style="margin-left: 1%;">
    <div class="col">
      <h4>The SpongeBob SquarePants Movie</h4>
    </div>
  </div>
  <br/>
  <div class="row" style="margin-left: 1%;">
  ...
  <div class="row" style="margin-left: 1%;">
    <div class="col">
      <p>The SpongeBob SquarePants Movie released on November 19th, 2004 (US release) and with it came the release
        of The SpongeBob SquarePants Movie video game. <br/>The video game itself was made to promote the movie and
        was released on Microsoft Windows and Mac OS X, Game Boy Advance, GameCube, PlayStation 2, and Xbox.
        <br/>The game is an Action-adventure 3D platformer on GameCube, PlayStation 2, and Xbox. The Game Boy
        Advance version is similar but it's a 2D version of the 3D games, while the Microsoft Windows edition
        is a point and click adventure game.
        <br/>
        <br/>For Speedrunning, I play on the Xbox version as it is the fastest version.
        <br/>
        <p>The ranking in the table below is accurate upon upload. Ranking is determined by comparing
          my time to other community member times on
        <a href="https://speedrun.com/tssm" target="_blank"> speedrun.com<a></p>
    </div>
  </div>
</div>
  ...
  <table class="table table-hover table-bordered" align="center" style="width: 75%;">
    ...
    <tbody>
      <?php
        ...
        $achievements = $conn -> prepare("select * from achievements where game_name = 'The SpongeBob SquarePants Movie' order by date_achieved DESC");
...
<div class="container-fluid" >
  <div class="row" style="text-align: center;">
    <div class="col">
      <p>If you want to check out every verified Speedrun of the game check out
        <a href="https://speedrun.com/tssm" target="_blank"> The SpongeBob SquarePants Movie
          speedrun.com</a> page. <br/>There are over <strong>100</strong> unique Speedruns of this
